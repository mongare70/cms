        ...
        var data = google.visualization.arrayToDataTable([
          ['Data', 'Count'],
            ...
            <?php 
                ...
                $element_count = [$post_count, $post_published_count, $post_draft_count, $comment_count, $unapproved_comment_count, $user_count, $subscriber_count, $admin_count, $category_count];
